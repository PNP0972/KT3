...
public class AdapterActivity extends BaseAdapter {
    ...
    private  int layout;
    private List<MainActivity> arraylist;

    public AdapterActivity(Context context, int layout, List<MainActivity> arraylist) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        MainActivity singerActivity = arraylist.get(i);
        //anhxa
